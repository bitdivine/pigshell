...
a=${cat http://bitdivine.com/sample/life-expectancy.html | table2js -e "tr" foo name years | jf 'x.name = x.name.trim(), x' | sort -f name}
...
a=${cat http://bitdivine.com/sample/life-expectancy.html | table2js -e "tr" foo name years | jf 'x.name = x.name.trim(), x'}
